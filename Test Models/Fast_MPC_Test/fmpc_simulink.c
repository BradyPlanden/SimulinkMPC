...
double mpc(mwSignedIndex T, mwSignedIndex m, mwSignedIndex n, mwSignedIndex niters, double kappa,
...
void fmpcsolve(double *A, double *B, double *At, double *Bt, double *eyen,
         ...
         double *x, double *z0, mwSignedIndex T, mwSignedIndex n, mwSignedIndex m, mwSignedIndex nz, mwSignedIndex niters, double kappa) 
{
