...
extern
#endif
unsigned int* __mw_instrum_0pJyfbHBfBFYuqwr56gYZF_cclib_phits;
...
extern
#endif
unsigned int __mw_instrum_0pJyfbHBfBFYuqwr56gYZF_cclib_enabled;

#define __MW_INSTRUM_RECORD_HIT_NO_TEST(id) ((void) ++__mw_instrum_0pJyfbHBfBFYuqwr56gYZF_cclib_phits[id - 1U])
#define __MW_INSTRUM_RECORD_HIT(id) ((__mw_instrum_0pJyfbHBfBFYuqwr56gYZF_cclib_enabled && __mw_instrum_0pJyfbHBfBFYuqwr56gYZF_cclib_phits) ? __MW_INSTRUM_RECORD_HIT_NO_TEST(id) : (void) 0)

static unsigned int *__mw_instrum_0pJyfbHBfBFYuqwr56gYZF_cclib_ptruth_tables;
...
extern
#endif
double __mw_instrum_0pJyfbHBfBFYuqwr56gYZF_cclib_abs_tol;
#ifdef __cplusplus
extern "C"
#else
extern
#endif
double __mw_instrum_0pJyfbHBfBFYuqwr56gYZF_cclib_rel_tol;

#define __MW_INSTRUM_ABS(a) ((a) < 0 ? -(a) : (a))
#define __MW_INSTRUM_MAX(lhs, rhs) ((lhs) < (rhs) ? (rhs) : (lhs))
#define __MW_INSTRUM_TOL(lhs, rhs) __MW_INSTRUM_MAX(__mw_instrum_0pJyfbHBfBFYuqwr56gYZF_cclib_abs_tol, __mw_instrum_0pJyfbHBfBFYuqwr56gYZF_cclib_rel_tol * __MW_INSTRUM_MAX(__MW_INSTRUM_ABS(lhs), __MW_INSTRUM_ABS(rhs)))

#define __MW_INSTRUM_NODE_1() \
  (((!__mw_instrum_0pJyfbHBfBFYuqwr56gYZF_cclib_enabled || __mw_instrum_0pJyfbHBfBFYuqwr56gYZF_cclib_ptruth_tables) ? \
    ((void) 0) : \
    ((void) (__mw_instrum_0pJyfbHBfBFYuqwr56gYZF_cclib_ptruth_tables = __MW_INSTRUM_0pJyfbHBfBFYuqwr56gYZF_cclib_INIT_FILE(0)))), \
   __MW_INSTRUM_RECORD_HIT(1U))
#define __MW_INSTRUM_NODE_2() \
  (__MW_INSTRUM_RECORD_HIT(2U))
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_3(...) ((__VA_ARGS__) ? (__MW_INSTRUM_RECORD_HIT(3U), (1 == 1)) : (__MW_INSTRUM_RECORD_HIT(4U), (0 == 1)))
#else
#define __MW_INSTRUM_NODE_3(expr) ((expr) ? (__MW_INSTRUM_RECORD_HIT(3U), 1) : (__MW_INSTRUM_RECORD_HIT(4U), 0))
#endif
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_1EZ_0pJyfbHBfBFYuqwr56gYZF(void) { }
#define __MW_INSTRUM_NODE_1() __MW_INSTRUM_RECORD_HIT_1EZ_0pJyfbHBfBFYuqwr56gYZF()
...
extern
#endif
int __MW_INSTRUM_RECORD_HIT_3DZ_0pJyfbHBfBFYuqwr56gYZF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_3(...) (__MW_INSTRUM_RECORD_HIT_3DZ_0pJyfbHBfBFYuqwr56gYZF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_3(exp) (__MW_INSTRUM_RECORD_HIT_3DZ_0pJyfbHBfBFYuqwr56gYZF(exp))
#endif
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_5XZ_0pJyfbHBfBFYuqwr56gYZF(void) { }
#define __MW_INSTRUM_NODE_5() __MW_INSTRUM_RECORD_HIT_5XZ_0pJyfbHBfBFYuqwr56gYZF()

#endif /* __MW_INTERNAL_SLDV_PS_ANALYSIS__ */

# 1 "/Users/bradyplanden/Documents/Git Repos/SimulinkMPC/C_Caller_Example/Dummy_Example/dummy.c"
...
#endif /* __MATH_H__ */
# 10 "/Users/bradyplanden/Documents/Git Repos/SimulinkMPC/C_Caller_Example/Dummy_Example/dummy.h"
#ifndef _DUMMY_H
#define _DUMMY_H

double dummy2(double * A, double * x, const int T, const int n); 
...
# 30797
#endif /* mllapack_h */
# 11 "/Users/bradyplanden/Documents/Git Repos/SimulinkMPC/C_Caller_Example/Dummy_Example/dummy.c"
const int ione = 1; 
const int itwo = 2; 
const int ithree = 3; 
const int iseven = 7; 
...
for (i = 0; __MW_INSTRUM_NODE_3(i < n * T); i++) { b[i] = (0); }  } 
dgemv_("n", &n, &n, &fone, A, &n, x, &ione, &fzero, b, &ione); 
{ double __mw_tmp_for_return = *b; __MW_INSTRUM_NODE_5(); return __mw_tmp_for_return; } } 
