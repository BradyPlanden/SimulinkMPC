###########################################################################
## Makefile generated for Simulink model 'test_mdl'. 
## 
## Makefile     : test_mdl.mk
## Generated on : Wed May 06 15:44:12 2020
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test_mdl
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/bradyplanden/Documents/Git\ Repos/SimulinkMPC/C_Caller_Example
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test_mdl
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/test_mdl_grt_rtw -I/usr/lib -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=test_mdl -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/test_mdl_grt_rtw/rtGetInf.c $(START_DIR)/test_mdl_grt_rtw/rtGetNaN.c $(START_DIR)/test_mdl_grt_rtw/rt_nonfinite.c $(START_DIR)/test_mdl_grt_rtw/test_mdl.c $(START_DIR)/test_mdl_grt_rtw/test_mdl_data.c $(START_DIR)/fmpc_simulink.c
...
OBJS = rt_logging.o rtGetInf.o rtGetNaN.o rt_nonfinite.o test_mdl.o test_mdl_data.o fmpc_simulink.o
...
LIBS = /usr/lib/libblas.dylib /usr/lib/liblapack.dylib
...
%.o : $(START_DIR)/test_mdl_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/test_mdl_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
