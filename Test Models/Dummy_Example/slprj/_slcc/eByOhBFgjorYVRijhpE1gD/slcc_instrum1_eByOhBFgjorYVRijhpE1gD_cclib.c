...
#endif /* __MATH_H__ */
# 10 "/Users/bradyplanden/Documents/Git Repos/SimulinkMPC/C_Caller_Example/fmpc.h"
#ifndef _FMPC_H
#define _FMPC_H

extern void mpc(const int T, const int m, const int n, const int niters, double kappa, double * A, double * B, double * Q, double * Qf, double * R, double * xmin, double * xmax, double * umin, double * umax, double * X0, double * U0, double * x0, double * U, double * X); 

extern void fmpcsolve(double * A, double * B, double * At, double * Bt, double * eyen, double * eyem, double * Q, double * R, double * Qf, double * zmax, double * zmin, double * x, double * z0, const int T, const int n, const int m, const int nz, const int niters, double kappa); 
...
# 30797
#endif /* mllapack_h */
# 19 "/Users/bradyplanden/Documents/Git Repos/SimulinkMPC/C_Caller_Example/fmpc_simulink.c"
const int ione = 1; 
const int itwo = 2; 
const int ithree = 3; 
const int iseven = 7; 
...
void mpc(const int T, const int m, const int n, const int niters, double kappa, double *
...
x, double *z0, const int T, const int n, const int m, const int nz, const int niters, double kappa) 
