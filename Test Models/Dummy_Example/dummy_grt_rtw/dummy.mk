###########################################################################
## Makefile generated for Simulink model 'dummy'. 
## 
## Makefile     : dummy.mk
## Generated on : Tue May 12 16:50:18 2020
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/dummy
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/bradyplanden/Documents/Git\ Repos/SimulinkMPC/C_Caller_Example/Dummy_Example
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/dummy
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/dummy_grt_rtw -I/usr/lib -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=dummy -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/dummy_grt_rtw/dummy.c $(START_DIR)/dummy_grt_rtw/dummy_data.c $(START_DIR)/dummy_grt_rtw/rtGetInf.c $(START_DIR)/dummy_grt_rtw/rtGetNaN.c $(START_DIR)/dummy_grt_rtw/rt_nonfinite.c $(START_DIR)/dummy_grt_rtw/dummy.c
...
OBJS = rt_logging.o dummy.o dummy_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o dummy.o
...
%.o : $(START_DIR)/dummy_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/dummy_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
