###########################################################################
## Makefile generated for Simulink model 'dummy2'. 
## 
## Makefile     : dummy2.mk
## Generated on : Mon May 18 19:19:41 2020
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/dummy2
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/bradyplanden/Documents/Git\ Repos/SimulinkMPC/Test\ Models/Dummy_Example
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/dummy2
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/dummy2_grt_rtw -I/usr/lib -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=dummy2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/dummy2_grt_rtw/dummy2.c $(START_DIR)/dummy2_grt_rtw/dummy2_data.c $(START_DIR)/dummy2_grt_rtw/rtGetInf.c $(START_DIR)/dummy2_grt_rtw/rtGetNaN.c $(START_DIR)/dummy2_grt_rtw/rt_nonfinite.c $(START_DIR)/dummy.c
...
OBJS = rt_logging.o dummy2.o dummy2_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o dummy.o
...
%.o : $(START_DIR)/dummy2_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/dummy2_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
