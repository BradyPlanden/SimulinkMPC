...
#ifndef RTW_HEADER_dummy2_h_
#define RTW_HEADER_dummy2_h_
#include <float.h>
#include <string.h>
#include <stddef.h>
#ifndef dummy2_COMMON_INCLUDES_
# define dummy2_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "rtw_continuous.h"
#include "rtw_solver.h"
#include "rt_logging.h"
#endif                                 /* dummy2_COMMON_INCLUDES_ */

#include "dummy2_types.h"
...
typedef struct {
   ...
   */
  real_T Constant3_Value[144];
} ConstP_dummy2_T;

/* Real-time Model Data Structure */
struct tag_RTM_dummy2_T {
...
/* Constant parameters (default storage) */
extern const ConstP_dummy2_T dummy2_ConstP;

/* Model entry point functions */
extern void dummy2_initialize(void);
extern void dummy2_step(void);
extern void dummy2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_dummy2_T *const dummy2_M;
