...
## Generated on : Wed May 06 11:20:37 2020
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/bradyplanden/Documents/Git\ Repos/SimulinkMPC
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/test_mdl_grt_rtw -I$(START_DIR)/C_Caller_Example -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/test_mdl_grt_rtw/rtGetInf.c $(START_DIR)/test_mdl_grt_rtw/rtGetNaN.c $(START_DIR)/test_mdl_grt_rtw/rt_nonfinite.c $(START_DIR)/test_mdl_grt_rtw/test_mdl.c $(START_DIR)/test_mdl_grt_rtw/test_mdl_data.c
...
OBJS = rt_logging.o rtGetInf.o rtGetNaN.o rt_nonfinite.o test_mdl.o test_mdl_data.o
