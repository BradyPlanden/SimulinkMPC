###########################################################################
## Makefile generated for Simulink model 'fMPC'. 
## 
## Makefile     : fMPC.mk
## Generated on : Fri May 22 19:27:26 2020
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/fMPC
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/bradyplanden/Documents/Git\ Repos/SimulinkMPC/fMPC
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/fMPC
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/fMPC_grt_rtw -I/usr/lib -I$(START_DIR)/src -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=fMPC -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/fMPC_grt_rtw/fMPC.c $(START_DIR)/fMPC_grt_rtw/fMPC_data.c $(START_DIR)/fMPC_grt_rtw/rtGetInf.c $(START_DIR)/fMPC_grt_rtw/rtGetNaN.c $(START_DIR)/fMPC_grt_rtw/rt_nonfinite.c $(START_DIR)/src/f_mpc.c
...
OBJS = rt_logging.o fMPC.o fMPC_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o f_mpc.o
...
%.o : $(START_DIR)/fMPC_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/fMPC_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
