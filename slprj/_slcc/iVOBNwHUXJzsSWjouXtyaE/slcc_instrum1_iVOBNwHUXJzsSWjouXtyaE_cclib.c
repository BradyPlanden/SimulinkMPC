...
extern void fmpcsolve(const double * A, const double * B, const double * At, const double * Bt, const double * eyen, const double * eyem, const double * Q, const double * R, const double * Qf, const double * zmax, const double * zmin, const double * x, const double * z0, const long T, const long n, const long m, const long nz, const long niters, const double kappa, double * z, double * U, double * X); 

extern void gfgphp(double * Q, double * R, double * Qf, double * zmax, double * zmin, double * z, const long T, const long n, const long m, const long nz, double * gf, double * gp, double * hp); 

extern void rdrp(double * A, double * B, double * Q, double * R, double * Qf, double * z, double * nu, double * gf, double * gp, double * b, const long T, const long n, const long m, const long nz, double kappa, double * rd, double * rp, double * Ctnu); 

extern void resdresp(double * rd, double * rp, const long T, const long n, const long nz, double * resd, double * resp, double * res); 

extern void dnudz(double * A, double * B, double * At, double * Bt, double * eyen, double * eyem, double * Q, double * R, double * Qf, double * hp, double * rd, double * rp, const long T, const long n, const long m, const long nz, double kappa, double * dnu, double * dz); 
...
Q, const double *R, const double *Qf, const double *zmax, const double *zmin, const double *x, const double *z0, const long T, const long n, const long m, const long 
nz, const long niters, const double kappa, double *z, double *U, double *X) 
...
rp, const long T, const long n, const long m, const long nz, double kappa, double *dnu, double *dz) 
...
gf, double *gp, double *b, const long T, const long n, const long m, const long nz, double 
...
void gfgphp(double *Q, double *R, double *Qf, double *zmax, double *zmin, double *z, const long 
T, const long n, const long m, const long nz, double *gf, double *gp, double *hp) 
...
void resdresp(double *rd, double *rp, const long T, const long n, const long nz, double *resd, double *
resp, double *res) 
