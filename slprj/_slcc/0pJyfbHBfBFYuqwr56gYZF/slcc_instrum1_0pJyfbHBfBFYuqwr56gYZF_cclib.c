...
extern
#endif
int __MW_INSTRUM_RECORD_HIT_4DZ_0pJyfbHBfBFYuqwr56gYZF(int condValue) { return condValue; }
#ifdef __cplusplus
#define __MW_INSTRUM_NODE_4(...) (__MW_INSTRUM_RECORD_HIT_4DZ_0pJyfbHBfBFYuqwr56gYZF(__VA_ARGS__))
#else
#define __MW_INSTRUM_NODE_4(exp) (__MW_INSTRUM_RECORD_HIT_4DZ_0pJyfbHBfBFYuqwr56gYZF(exp))
#endif
...
extern
#endif
void __MW_INSTRUM_RECORD_HIT_6XZ_0pJyfbHBfBFYuqwr56gYZF(void) { }
#define __MW_INSTRUM_NODE_6() __MW_INSTRUM_RECORD_HIT_6XZ_0pJyfbHBfBFYuqwr56gYZF()

#endif /* __MW_INTERNAL_SLDV_PS_ANALYSIS__ */

# 1 "/Users/bradyplanden/Documents/Git Repos/SimulinkMPC/Test Models/Dummy_Example/dummy.c"
...
#endif /* __MATH_H__ */
# 9 "/Users/bradyplanden/Documents/Git Repos/SimulinkMPC/Test Models/Dummy_Example/dummy.h"
#ifndef _DUMMY_H
#define _DUMMY_H

double dummy2(double * A, double * x, const long T, const long n, double * eyen); 
...
# 30797
#endif /* mllapack_h */
# 11 "/Users/bradyplanden/Documents/Git Repos/SimulinkMPC/Test Models/Dummy_Example/dummy.c"
const long ione = (1); 
const int itwo = 2; 
const int ithree = 3; 
const int iseven = 7; 
...
At = (__MW_INSTRUM_NODE_3(), malloc((sizeof(double) * n) * n)); { 


for (i = 0; __MW_INSTRUM_NODE_4(i < n * T); i++) { b[i] = (0); }  } 

dgemm_("t", "n", &n, &n, &n, &fone, A, &n, eyen, &n, &fzero, At, &n); 
{ double __mw_tmp_for_return = At[12]; __MW_INSTRUM_NODE_6(); return __mw_tmp_for_return; } } 
